...
const generateManager = managerTitle => { return managerTitle.map(manager => {
    ...
    <div class="col">
        <div class="card shadow-lg" style="width: 18rem;">
            <div class="card-body identity" style="color: white;">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Email: <a href="mail-to" target="_blank">${manager.getEmail()}</a></li>
    ...
    <div class="col">
        <div class="card shadow-lg" style="width: 18rem;">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Email: <a href="mail-to" target="_blank">${intern.getEmail()}</a></li>
    ...
    <div class="col">
        <div class="card shadow-lg" style="width: 18rem;">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Email: <a href="mailto:" target="_blank">${engineer.getEmail()}</a></li>
                <li class="list-group-item">GitHub: <a href="https://github.com/" target="_blank">${engineer.getGithub()}</a></li>
            </ul>
        </div>
    </div>
    `
